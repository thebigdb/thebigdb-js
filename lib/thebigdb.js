...
(function() {
  ...
  this.TheBigDB = (function() {
    var mergeOptions, serializeQueryParams;
    ...
    function TheBigDB(options) {
      ...
      this.configuration = mergeOptions(defaultConfiguration, options);
    ...
    TheBigDB.prototype.Sentence = function(action, params, successCallback, errorCallback) {
    ...
    TheBigDB.prototype.Toolbox = function() {
      var _this = this;
      return {
        Units: function(action, params, successCallback, errorCallback) {
          var method, path;
          method = "GET";
          path = "/toolbox/units/" + action;
          return _this.executeRequest(method, path, params, successCallback, errorCallback);
        }
      };
    };
    ...
    TheBigDB.prototype.executeRequest = function(method, path, params, successCallback, errorCallback) {
      ...
      url = "" + scheme + "://" + this.configuration.apiHost + ":" + this.configuration.apiPort + "/api/v" + this.configuration.apiVersion + path;
      if (method === "GET") {
      ...
      return xhr.send(serializeQueryParams(params));
    };

    serializeQueryParams = function(obj, prefix) {
      ...
      str = (function() {
        ...
        for (key in obj) {
          value = obj[key];
          param_key = obj.constructor === Array ? prefix ? "" + prefix + "[]" : key : prefix ? "" + prefix + "[" + key + "]" : key;
          if (typeof value === "object") {
            _results.push(serializeQueryParams(value, param_key));
          } else {
